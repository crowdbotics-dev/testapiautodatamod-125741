...
## Project Structure
    ...
    ├── testapiautodatamod_125741  # Django project configurations
...
1. Clone this repo and `cd testapiautodatamod_125741`
...
2. Clone this repo and `cd testapiautodatamod_125741`
